...
export default function EmailPopu() {
...
console.log( SIGNUPUSERDATA,"kkin")
  dispatch(RegisterUser(SIGNUPUSERDATA))
  
}
 
  return (
    <div>
      <button type="button"className="registerform"  onClick={handleOpen}>
    Continue With Email
      </button>
      <Modal
